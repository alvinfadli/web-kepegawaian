<?php
  ...
  $namaPegawai = current($conn->query("SELECT nama FROM pegawai WHERE id='$pegawaiUsername'")->fetch_assoc());
        ...
        <div class="card-deck row justify-content-center">
          <div class="col-xs-12 col-sm-6 col-md-5">
            ...
            <div class="card">
              ...
              <!--Card content-->
              <a href="pegawai_data_pribadi.php" class="cardLinks">
                <div class="card-body text-center">
                  <h4 class="card-title">Data Pribadi</h4>
                  <p class="card-text">
                    Personalisasi laporan data pribadi anda di halaman ini
                  </p>
                </div>
              </a>
            </div>
            ...
            <div class="card mb-4">
              ...
              <a href="#" class="cardLinks">
                <div class="card-body text-center">
                  ...
                  <p class="card-text">
                    Proses pengajuan jabatan dan cuti anda di halaman ini
                  </p>
                </div>
              </a>
            </div>
